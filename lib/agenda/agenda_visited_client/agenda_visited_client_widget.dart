...
import 'agenda_visited_client_model.dart';
export 'agenda_visited_client_model.dart';

class AgendaVisitedClientWidget extends StatefulWidget {
  const AgendaVisitedClientWidget({super.key});

  @override
  State<AgendaVisitedClientWidget> createState() =>
      _AgendaVisitedClientWidgetState();
}

class _AgendaVisitedClientWidgetState extends State<AgendaVisitedClientWidget> {
  late AgendaVisitedClientModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AgendaVisitedClientModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsersRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRow> agendaVisitedClientUsersRowList = snapshot.data!;

        final agendaVisitedClientUsersRow =
            agendaVisitedClientUsersRowList.isNotEmpty
                ? agendaVisitedClientUsersRowList.first
                : null;
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                height:
                                    MediaQuery.sizeOf(context).height * 0.576,
                                decoration: BoxDecoration(),
                                child: Visibility(
                                  visible: responsiveVisibility(
                                    context: context,
                                  ...
                                  child: FutureBuilder<
                                    ...
                                    future:
                                        CompanyVisitSummaryTable().queryRows(
                                      queryFn: (q) => q,
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            valueOrDefault<String>(
                                                                              listViewSelectedCompanyVisitSummaryRow.nameCompany,
                                                                      ...
                                                                      onPressed:
                                                                        ...
                                                                        context
                                                                          ...
                                                                          queryParameters:
                                                                            ...
                                                                            'idChinalinker':
                                                                                serializeParam(
                                                                              listViewSelectedCompanyVisitSummaryRow.chinalinker,
                                                                              ParamType.int,
                                                                            ),
                                                                          }.withoutNulls,
                                                                        );
