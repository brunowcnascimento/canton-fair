...
import 'lista_cliente_model.dart';
export 'lista_cliente_model.dart';

class ListaClienteWidget extends StatefulWidget {
  /// Visualização do perfil Chinalinker
  const ListaClienteWidget({super.key});

  @override
  State<ListaClienteWidget> createState() => _ListaClienteWidgetState();
}

class _ListaClienteWidgetState extends State<ListaClienteWidget> {
  late ListaClienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaClienteModel());
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            height: 498.0,
                            decoration: BoxDecoration(),
                            child: FutureBuilder<List<SupplierRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return ListView.builder(
                                  ...
                                  itemCount:
                                      listViewSelectedSupplierRowList.length,
                                  itemBuilder:
