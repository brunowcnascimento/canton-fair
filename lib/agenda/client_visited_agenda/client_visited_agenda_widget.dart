...
import 'client_visited_agenda_model.dart';
export 'client_visited_agenda_model.dart';

class ClientVisitedAgendaWidget extends StatefulWidget {
  const ClientVisitedAgendaWidget({super.key});

  @override
  State<ClientVisitedAgendaWidget> createState() =>
      _ClientVisitedAgendaWidgetState();
}

class _ClientVisitedAgendaWidgetState extends State<ClientVisitedAgendaWidget> {
  late ClientVisitedAgendaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClientVisitedAgendaModel());
                            ...
                            children: [
                              Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    if (FFAppState().user ==
                                        UserType.Cliente.name) {
                                      context
                                          .pushNamed('InformationPageCliente');
                                    } else {
